...
/* ALT HOLD PID stuff */
void PIDController_Init(PIDControllerType *pid) {
	...
	/*Must always be initialized by the user*/
	/* start with 0 error on Init*/
...
float PIDController_Update(PIDControllerType *pid, float setpoint, float measurement) {
